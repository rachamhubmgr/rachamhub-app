...
export default function MerchantStockPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const [{ data: merchantData }, { data: productData }, { data: entryData }] =
        await Promise.all([
  ...
  const approvedCount = stockEntries.filter((e) => e.status === "approved").length;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-6 flex items-center justify-between border-0 shadow-sm">
          <div>
            ...
            <p className="text-2xl font-bold mt-1 text-slate-900">{stockEntries.length}</p>
          </div>
      ...
      <Card className="p-6 border-0 shadow-sm">
        <h2 className="text-lg font-semibold mb-4 text-slate-900">Recent Stock Entries</h2>
        {loading ? (
      ...
      <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Select a merchant and product to add inbound stock.
              Entries are pending until approved by an authorized user.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              >
                <option value="">
                  {selectedMerchant ? "Select product..." : "Select a merchant first"}
                </option>
