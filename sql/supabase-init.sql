...
create trigger merchant_access_keys_set_updated_at before
update on public.merchant_access_keys for each row execute procedure public.set_updated_at();
...
create trigger stock_entries_set_updated_at before
update on public.stock_entries for each row execute procedure public.set_updated_at();
-- =====================
